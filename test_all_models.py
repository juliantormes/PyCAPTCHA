...
def test_ensemble():
    ...
    try:
        # Import ensemble predictor dynamically
        ensemble_file = os.path.join('models', '04_ensemble', 'ensemble_predictor.py')
...
def test_ensemble_with_postprocessing():
    ...
    try:
        ...
        postprocessor_file = os.path.join('experiments', 'postprocessing', 'captcha_postprocessor.py')
...
def main():
    ...
    models = [
        ("Baseline v1", "models/01_baseline/model.pth"),
        ("Advanced v2", "models/02_advanced/model.pth"),
        ("Specialized v3 ⭐", "models/03_specialized_sssalud/model.pth"),
    ]
